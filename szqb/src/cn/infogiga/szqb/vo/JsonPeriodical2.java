...
public class JsonPeriodical2 {
	...
	public void setAddTime(String addTime) {
		this.addTime = DateUtil.getDateString(DateUtil.stringToDate(addTime, DateUtil.NOW_TIME), DateUtil.NOW_DATE);
	}
	...
	public void setPublishTime(String publishTime) {
		this.publishTime = DateUtil.getDateString(DateUtil.stringToDate(publishTime, DateUtil.NOW_TIME), DateUtil.NOW_DATE);
