			...
			<div id="context">
				<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
					<TR height=100>
						...
						<TD>
						<TD colSpan=3>
  	 <form action="exeUpdate?sysinfo" method="post" id="addForm">
   		<table>
   			<tr>
   				<td>系统名称：</td>
   				<td><input type="text" name="systemName" value="${item.systemName}"/></td>
   			</tr>
   			...
   			<tr>
   				<td>
   				<input type="hidden" name="systemId" value="${item.systemId}"/>
