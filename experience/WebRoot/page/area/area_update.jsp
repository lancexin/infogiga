			...
			<div id="context">
				<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
					<TR height=100>
						...
						<TD>
						<TD colSpan=3>
					  	 <form action="exeUpdate?area" method="post" id="addForm">
					   		<table>
					   			<tr>
					   				<td>地区名称：</td>
					   				<td><input type="text" name="areaName" value="${item.areaName}"/></td>
					   			</tr>
					   			<tr>
					   				<td>地区编号：</td>
					   				<td><input type="text" name="areaCode" value="${item.areaCode}"/></td>
					   			</tr>
					   			
					
					   			<tr>
					   				<td>
					   				<input type="hidden" name="id" value="${item.areaId}"/>
