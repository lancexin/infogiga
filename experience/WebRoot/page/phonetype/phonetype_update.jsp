			...
			<div id="context">
				<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
					<TR height=100>
						...
						<TD>
						<TD colSpan=3>
  	 <form action="exeUpdate?phonetype" method="post" id="addForm">
   		<table>
   			<tr>
   				<td>手机厂商：</td>
   				<td><select name="phonebrandId">
   					<c:forEach items="${phonebrandList}" var="phonebrand">
   						<option <c:if test="${phonebrand.phonebrandId == item.phonebrand.phonebrandId}">selected="selected"</c:if>ngy value="${phonebrand.phonebrandId }">${phonebrand.phonebrandName }</option>
   			...
   			<tr>
   				<td>型号名称：</td>
   				<td><input name="phonetypeName" type="text" value="${item.phonetypeName }"/></td>
   			</tr>
   			...
   			<tr>
   				<td>
   				<input type="hidden" name="phonetypeId" value="${item.phonebrand.phonebrandId}"/>
