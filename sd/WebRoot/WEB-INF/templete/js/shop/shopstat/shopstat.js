var newComponent = (function() {
	...
	var musicPanel = (function(){
		var store = new Ext.data.JsonStore({
	    	url:"json?musicdownloadstatList&type=json",
	    	root:"data",
	    ...
	    var downloadtypeStore = new Ext.data.JsonStore({ 
			...
			url :'json?comboDownloadtype&type=json', 
			...
			tbar:[{
	             ...
	             handler : function(){
	             	var params = Ext.getCmp('searchForm').getForm().getValues(true);
	              	...
	              	window.location = 'export?musicdownloadstat&'+params;
	...
	var videoPanel = (function() {
		var store = new Ext.data.JsonStore({
	    	url:"json?videodownloadstatList&type=json",
	    	root:"data",
	    	totalProperty:"totalCount",//返回的总页数
	        fields: [
	            {name: 'statId'},
		...
		var dataGrid = new Ext.grid.GridPanel({
			...
			tbar:[{
	             ...
	             handler : function(){
	             	var params = Ext.getCmp('searchForm').getForm().getValues(true);
	              	//window.loaction.href = 'export?softdownloadstat&'+params;
	              	window.location = 'export?videodownloadstat&'+params;
	              	//alert(window.location);
	             }
	        }],
	...
	var tabPanel = new Ext.TabPanel({
     	region: 'center',
  		...
  		animScroll : true,   
  		activeTab: 0,
  		items: [musicPanel,softPanel,videoPanel]
     });
