...
function preload() {
	new Image().src="../image/common/before.png";
	new Image().src="../image/common/next.png";
	new Image().src="../image/Start/m-l-phone.png";
	new Image().src="../image/Start/m-l-people.png";
	new Image().src="../image/Start/m-l-text.png";
	new Image().src="../image/Start/m-l-outlook.png";
	new Image().src="../image/Start/m-l-pictures.png";
	new Image().src="../image/Start/m-l-games.png";
	new Image().src="../image/Start/m-l-me.png";
	new Image().src="../image/Start/m-l-music-video.png";
	new Image().src="../image/Start/m-l-ie.png";
	new Image().src="../image/Start/m-l-calendar.png";
	for (mi=0;mi<startP.m_array_right.length;mi++) {
		new Image().src=startP.m_array_right[mi].bg;
	}
}
...
function eventListen() {	
	var meb = document.getElementById('menu_box_left');
	meb.addEventListener('touchstart', function(e){
		e.preventDefault();
		X.startX = e.targetTouches[0].clientX;
		X.startY = e.targetTouches[0].clientY;	
		X.touching = true;
	});
	meb.addEventListener('touchmove', function(e){
		e.preventDefault();
		var dx = e.targetTouches[0].clientX - X.startX;
		var dy = e.targetTouches[0].clientY - X.startY;
		this.style.top = (this.offsetTop+dy)+'px';
		X.startX = e.targetTouches[0].clientX;
		X.startY = e.targetTouches[0].clientY;	
	});
	meb.addEventListener('touchend', function(e){
		e.preventDefault();
		X.touching = false;
	});
