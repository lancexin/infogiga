<%@ page language="java"
	import="java.util.List,cn.infogiga.bean.Comment,cn.infogiga.util.DateUtil"
	pageEncoding="utf-8"%>
<html>
	<head>
		...
		<div class="container">
			...
			<div id="result" class="request-div-e">
				...
				<div class="request-show-result">
					<div>
						时间：<%=DateUtil.getDateString(req.getReceiveTime(),
