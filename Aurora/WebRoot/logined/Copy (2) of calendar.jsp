...
<jsp:include page="setup-singleInfo.jsp"></jsp:include>
<jsp:include page="setup-templete.jsp"></jsp:include>
<jsp:include page="setup-option.jsp"></jsp:include>
<jsp:include page="setup-account.jsp"></jsp:include>
