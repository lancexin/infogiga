...
<div id="wrap">
    ...
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; 公司介绍</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>公司介绍</h2>
            <p>暂无</p>           
	...
	<div id="version">
		<p>&lt;<a href="q?p=7&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=7&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
