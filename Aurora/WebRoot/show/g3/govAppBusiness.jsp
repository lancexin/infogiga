...
<title>政府行业应用介绍 | 杭州移动信息化体验馆</title>
...
<div id="wrap">
    ...
    <div id="nav">
        <ul>
            ...
            <li><%if(in) {%><a href="q?p=124&v=3&sc=<%=showCode?0:1%>">二维码</a><%}else{%><a href="q?p=4&v=3">登录</a><%} %></li>
        </ul>
    </div>
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=3">首页</a>&raquo; <a href="q?p=12&v=3">生产控制区介绍</a>&raquo; 政府行业应用介绍</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
            <p>政府是电子信息技术的最大使用者，也是信息资源的最大拥有者。中国移动杭州分公司顺应政府信息化的时代潮流，发挥移动信息技术优势，构建紧贴政府运作需求的信息化服务。其中警务通、税务通、场馆同就是中国移动航走分公司运用先进的移动信息技术力助政府信息化、提升政府部门政务管理能力的一个缩影。</p>
            <p class="more"><a href="q?p=12&v=3">&laquo; 返回上层</a></p>
        </div>
    </div>
	<div id="version">
		<p>&lt;<a href="q?p=124&v=2">彩版</a>|<span class="bk">G3版</span>|<a href="q?p=124&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
