...
<div id="wrap">
    ...
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; <a href="q?p=13&v=2">服务营销区介绍</a>&raquo; 手机搜索</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
	...
	<div id="version">
		<p>&lt;<a href="q?p=132&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=132&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
