...
<div id="wrap">
    ...
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; <a href="q?p=14&v=2">楼宇管理区介绍</a>&raquo; 无线视频监控</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
...
无线视频监控系统由四大部分组成：传输网络、前端设备、中心后台、监控终端，该系统整合了TD-SCDMA网络和INTERNET网络的优势，无论您身在何处、任何时间、都可以迅速接入系统，随时随地的进行远程监控管理。（案例：富阳港航局）</p>
	...
	<div id="version">
		<p>&lt;<a href="q?p=142&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=142&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
