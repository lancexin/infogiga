...
<div id="wrap">
    ...
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; <a href="q?p=12&v=2">生产控制区介绍</a>&raquo; 行业语音报警</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
...
技术上：主要通过IT技术、移动通信技术、数据库技术实现整个系统所需的后台处理、通信交互、语音呼叫调度、报表自动生成、手机定位以及一线干警人员的手持设备和相应的管理信息客户端。通过上述4种技术的互动，实现不同区域、不同管理人员、不同管理对象和不同管理主体的信息一体化处理。达到：接处警快速准确性、系统实用可靠性、派出所联动性、科学决策分析。最终通过该语音位置服务系统实现公安部门接处警能力的提升、管理人员评估体系信息化和事务处理效率的提高。（案例：杭州市公安局）</p>
	...
	<div id="version">
		<p>&lt;<a href="q?p=120&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=120&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
