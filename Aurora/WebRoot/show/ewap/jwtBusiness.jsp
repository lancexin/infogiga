...
<div id="wrap">
    ...
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; <a href="q?p=12&v=2">生产控制区介绍</a>&raquo; 警务通</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
 ...
 后台即移动警务的信息来源，主要是公安内部网络系统。通过中间件连接数据库，进行各种业务处理。（案例：杭州市公安局）</p>
	...
	<div id="version">
		<p>&lt;<a href="q?p=125&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=125&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
