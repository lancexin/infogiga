...
<div id="wrap">
    ...
    <div id="nav">
        <ul>
            ...
            <li><%if(in) {}else{%><a href="q?p=4&v=2">登录</a><%} %></li>
        </ul>
    </div>
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; 服务条款</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>服务条款</h2>
            <p>暂无</p>           
	...
	<div id="version">
		<p>&lt;<a href="q?p=8&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=8&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
