...
var newComponent = (function(){
	 ...
	 var provinceStore = new Ext.data.JsonStore({
	 	autoLoad:true,
    	url:"json?provinceList&type=json",
    	root:"data",
