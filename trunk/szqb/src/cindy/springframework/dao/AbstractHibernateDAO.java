...
package cindy.springframework.dao;
...
public abstract class AbstractHibernateDAO extends HibernateDaoSupport{
	...
	public <T extends Serializable> List<T> findAll(final Class<T> clazz,final String order) {
	...
	public <T extends Serializable> List<T> findByProperties(final Class<T> clazz,
			final Map<String,Object> properties,final String order) {
		return (List<T>) getHibernateTemplate().execute(new HibernateCallback(){
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
				final Criteria c = session.createCriteria(clazz);
	...
	public <T extends Serializable> List<T> findByProperty(final Class<T> clazz,
			final String propertyName,final Object value,final String order) {
		return (List<T>) getHibernateTemplate().execute(new HibernateCallback(){
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
				final Criteria c = session.createCriteria(clazz);
	...
	public <T extends Serializable> List<T> getListByPage(final Class<T> clazz,final Integer start,final Integer limit,final String order){
		return (List<T>) getHibernateTemplate().execute(new HibernateCallback(){
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
				final Criteria c = session.createCriteria(clazz);
	...
	public <T extends Serializable> List<T> getListByProperty(final Class<T> clazz,final String property,final Object value,final Integer start,final Integer limit,final String order){
		return (List<T>) getHibernateTemplate().execute(new HibernateCallback(){
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
				final Criteria c = session.createCriteria(clazz);
	...
	public <T extends Serializable> List<T> getListByProperties(final Class<T> clazz,final Map<String,Object> properties,final Integer start,final Integer limit,final String order){
		return (List<T>) getHibernateTemplate().execute(new HibernateCallback(){
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
				final Criteria c = session.createCriteria(clazz);
