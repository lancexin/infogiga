...
public class XlsMergeUtil {   
 // private static Logger logger = LoggerFactory.getLogger(XlsMergeUtil.class);   
  ...
  public static void main(String[] args) throws Exception {   
    /*final String PATH = "F:\\excel\\";   
    InputStream[] inputs = new InputStream[5];   
   // inputs[0] = new java.io.FileInputStream(PATH + "20101110.xls");   
    for(int i = 0; i < 5 ; i++) {   
      inputs[i] = new java.io.FileInputStream(PATH + "xx.xls");   
    }   
    OutputStream out = new FileOutputStream(PATH + "xx2.xls");   
    long t1 = System.currentTimeMillis();   
    merge(inputs, out);   
    System.out.println(System.currentTimeMillis() - t1);   */
	  String s = "wap.hzmstore.com/soft/down/wwwwwwww_sb0203.sisx?id=11111111111111111111111111111111";
