			...
			<div id="context">
				<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
					<TR height=100>
						...
						<TD>
						<TD colSpan=3>
  	 <form action="exeUpdate?phonebrand" method="post" id="addForm">
   		<table>
   			<tr>
   				<td>厂商名称：</td>
   				<td><input type="text" name="phonebrandName" value="${item.phonebrandName}"/></td>
   			</tr>
   			

   			<tr>
   				<td>
   				<input type="hidden" name="phonebrandId" value="${item.phonebrandId}"/>
