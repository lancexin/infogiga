			...
			<div id="context">
				<TABLE cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
					<TR height=100>
						...
						<TD>
						<TD colSpan=3>
						  	 <form action="exeAdd?phonetype" method="post" id="addForm">
						   		<table>
						   			<tr>
						   				<td>手机厂商：</td>
						   				<td><select name="phonebrandId">
						   					<c:forEach items="${phonebrandList}" var="p">
						   						<option value="${p.phonebrandId }">${p.phonebrandName }</option>
						   					</c:forEach>
						   				</select></td>
						   			</tr>
						   			<tr>
						   				<td>型号名称：</td>
						   				<td><input name="phonetypeName" type="text"/></td>
						   			</tr>
