...
function CalendarInit()             ///Create panel
{
    ...
    if ( document.all){
       htmlAll="<div id='"+this.sDIVID+"' style='display:none;position:absolute;width:178px;border:"+this.divBorderCss+";padding:1px;background-color:#FFFFFF;z-index:100';>";
    }else{
       htmlAll="<div id='"+this.sDIVID+"' style='display:none;position:absolute;width:178px;border:"+this.divBorderCss+";padding:1px;background-color:#FFFFFF;z-index:100';>";
    }
    ...
    htmloYear+="</select>";
    /// Day
    htmloDayTable="<table id='"+this.sTABLEID+"' width='178' border=0 cellpadding=0 cellspacing=1 bgcolor='"+this.tableBorderColor+"'>";
...
function CalendarCellsClick(oCell,oInstance)
{
    ...
    sDateString=sYear+'-'+CalendarDblNum(sMonth+1)+'-'+CalendarDblNum(sDay)+" 00:00:00"; ///output
    //alert(sDateString);
    ...
    //parent.document.getElementById('page').style.height = document.body.scrollHeight; 
	//parent.document.body.scrollTop = document.body.scrollHeight;//auto scroll
}
...
{
	//document.all.searchBar.style.top = parent.document.body.scrollTop+ parent.document.body.clientHeight- 370;	
