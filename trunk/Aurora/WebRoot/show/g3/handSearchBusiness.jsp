...
<div id="wrap">
    ...
    <div id="nav">
        <ul>
            ...
            <li><%if(in) {%><a href="q?p=132&v=3&sc=<%=showCode?0:1%>">二维码</a><%}else{%><a href="q?p=4&v=3">登录</a><%} %></li>
        </ul>
    </div>
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=3">首页</a>&raquo; <a href="q?p=13&v=3">服务营销区介绍</a>&raquo; 手机搜索</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
            <p>怕客户到不到你-→手机搜索让手机用户轻松找到有关您企业的信息，用户只要八项查询的内容以短信的形式“搜+内容”发送到10086，就可以准确查找到他所需要的各类网页内容，通过点击反馈的信息链接即可浏览相关网页内容。                                                                    酒香也怕巷子深-→企业利用关键词营销、搜索排名可以让企业信息不经意间出现在用户眼前。</p>
            <p class="more"><a href="q?p=13&v=3">&laquo; 返回上层</a></p>
        </div>
    </div>
	<div id="version">
		<p>&lt;<a href="q?p=132&v=2">彩版</a>|<span class="bk">G3版</span>|<a href="q?p=132&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
