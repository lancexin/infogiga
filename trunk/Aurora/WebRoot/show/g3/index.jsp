...
<div id="wrap">
    ...
    <div id="nav">
        <ul>
            ...
            <li><%if(in) {%><a href="q?p=1&v=3&sc=<%=showCode?0:1%>">二维码</a><%}else{%><a href="q?p=4&v=3">登录</a><%} %></li>
        </ul>
    </div>
    <div id="content">
        <%if(in && showCode) {%>
        ...
        <div id="intro">
            ...
            <p class="more"><a href="q?p=2&v=3">&raquo; 继续阅读</a></p>
        </div>
    </div>
    <div id="bottom-nav">
    	<ul>
        	<a href="q?p=11&v=3"><li>移动办公区</li></a>    		
        	<a href="q?p=12&v=3"><li>生产控制区</li></a>    		
        	<a href="q?p=13&v=3"><li>服务营销区</li></a>    		
        	<a href="q?p=14&v=3"><li>楼宇管理区</li></a>    		
        	<a href="q?p=15&v=3"><li>基础网络区</li></a>    		
        </ul>
    </div>    
	<div id="version">
		<p>&lt;<a href="q?p=1&v=2">彩版</a>|<span class="bk">G3版</span>|<a href="q?p=1&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
