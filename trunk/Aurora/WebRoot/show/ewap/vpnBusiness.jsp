...
<div id="wrap">
    ...
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; <a href="q?p=11&v=2">移动办公区介绍</a>&raquo; 融合VPN</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
            <p>多张虚拟网各管各的——手机、固话、PC融入一张虚拟网内，用户同群、短号互拨，用移动优势覆盖固定业务。
单一接入，切换麻烦——支持多种接入方式，群内用户统一编号。
企业跨地域，组网困难——跨地域企业组网，更有集团短信/企业通信录支持。
没有统一账单，自费省不下来——提供统一账单，6类用户群内通话自费优惠。（案例：杭州日报、浙江中大集团股份有限公司）</p>
            <p class="more"><a href="q?p=11&v=2">&laquo; 返回上层</a></p>
        </div>
    </div>
	<div id="version">
		<p>&lt;<a href="q?p=113&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=113&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
