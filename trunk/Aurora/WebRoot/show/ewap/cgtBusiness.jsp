...
<div id="wrap">
    ...
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; <a href="q?p=12&v=2">生产控制区介绍</a>&raquo; 城管通</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
...
根据不同的权限管理共实现了以下功能：用户管理、问题上报、个人任务历史记录、信息提示、语音功能、短信呼叫、拍照录音、表单填写、报表自动生成、地图实时获取、地图浏览、GPS定位、查询及统计、打印功能、数据同步、智能报警、公共信息查询、公文查询、人员查询、系统设置、使用帮助（案例：杭州市行政执法大队）</p>
	...
	<div id="version">
		<p>&lt;<a href="q?p=127&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=127&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
