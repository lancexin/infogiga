...
<div id="wrap">
    ...
    <div id="content">
    	<div id="crumb-nav" class="small"><a href="q?p=1&v=2">首页</a>&raquo; <a href="q?p=12&v=2">生产控制区介绍</a>&raquo; 政府行业应用介绍</div>
        <div id="thumb"></div>
        <div id="intro">
            <h2>业务介绍</h2>
	...
	<div id="version">
		<p>&lt;<a href="q?p=124&v=3">G3版</a>|<span class="bk">彩版</span>|<a href="q?p=124&v=1">简版</a>&gt;</p>
	</div>
    <div id="widget">
