...
(function($) {
    ...
    $.fn.bcalendar = function(option) {
        var def = {
            ...
            CalDateShow:function(startday, endday, isshowtime, isshowweek) {
	            if (!endday) {
       ...
       function centerView(){
        ...
        function quickadd(start, end, isallday, pos) {
        	...
        	if(option.quickadd){
        		return option.quickadd(start, end, isallday, pos);
        	}else{
        		alert("权限不够");
        		return false;
        	}
